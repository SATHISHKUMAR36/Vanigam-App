...
class _SingleleadState extends State<Singlelead> {
  ...
  deletenote(stackholdertype, noteid) async {
    await _crmProvider.deletenote(stackholdertype, noteid,_userProvider.selectedworkspace?.branchid,);
  }
  ...
  Future<List> _showMyDialog(context, currentTheme, notes, lastmsgdates) async {
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: Scaffold(
        appBar: AppBar(
          title: Text("${AppLocalizations.of(context).translate("LeadsView")}"),

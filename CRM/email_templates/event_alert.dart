...
class EventAlert extends StatefulWidget {
  List emails;
  EventAlert({super.key, required this.emails});
...
class _EventAlertState extends State<EventAlert> {
  ...
  String? headerlink;
  String middlerfilename = "No file chosen";
  String? middleimagelink;
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
        child: Scaffold(
      appBar: AppBar(
        title: Text("${AppLocalizations.of(context).translate("EventAlertMail")}"),
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
                padding: const EdgeInsets.only(bottom: 10, left: 10, right: 10),
                child: _buildInputField('${AppLocalizations.of(context).translate("AlternativeSubject")}', altheader, false,
                    Icons.list_alt_rounded, currentTheme)
            ...
            Padding(
                padding: const EdgeInsets.only(bottom: 10, left: 10, right: 10),
                child: _buildInputField('${AppLocalizations.of(context).translate("CTAlink")}', ctalink, true,
                    Icons.insert_link, currentTheme)
            ...
            Padding(
                padding: const EdgeInsets.only(bottom: 10, left: 10, right: 10),
                child: _buildInputField('${AppLocalizations.of(context).translate("CTAname")}', ctabuttonname,
                    false, Icons.indeterminate_check_box, currentTheme)
                  ...
                  InkWell(
                    onTap: () async {
                      ...
                      if (result != null) {
                        ...
                        context.loaderOverlay.hide();
                        setState(() {
                          middlerfilename = files.name;
                          middleimagelink = _crmProvider.s3link;
                        });
                      }
                    },
                    child: Container(
                      ...
                      child: Center(
                          child: Text(
                        "${AppLocalizations.of(context).translate("upload_mid")}",
                        style: currentTheme.textTheme.displayLarge!
                            .copyWith(color: currentTheme.primaryColor),
                      )),
                    ),
              ...
              child: Align(
                ...
                child: Container(
                  ...
                  child: InkWell(
                    ...
                    onTap: () async {
                      context.loaderOverlay.show();
                      htmldata = await Crmapi.previeweventmail(
                          subject.text,
                          widget.emails,
                          title.text,
                          headerlink,
                  ...
                  child: InkWell(
                    ...
                    onTap: () async {
                      if (_formKey.currentState!.validate()) {
                        if (middleimagelink != null && headerlink != null) {
                          context.loaderOverlay.show();
                          bool event = await Crmapi.eventmail(
                              subject.text,
                              widget.emails,
                              title.text,
                              headerlink,
                          ...
                          if (event) {
                            const snackBar = SnackBar(
                                duration: Duration(seconds: 3),
                                content:
                                    Text("Event mail was send succesfully..!"),

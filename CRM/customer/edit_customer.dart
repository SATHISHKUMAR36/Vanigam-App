...
class EditCustomer extends StatefulWidget {
  ...
  List? productnames; //Gst ,advtax, annual tax, notices
  EditCustomer(
      {super.key,
      this.userid,
      this.name,
                      ...
                      child: Column(
                        children: [
                          Padding(
                              ...
                              child: _buildInputField('Name', name, false,
                                  Icons.person, currentTheme)),
                          Padding(
                              padding: const EdgeInsets.only(
                                  bottom: 10, left: 10, right: 10),
                              child: _buildInputField('Email', email, false,
                                  Icons.mail, currentTheme)),
                          Padding(
                              padding: const EdgeInsets.only(
                                  bottom: 10, left: 10, right: 10),
                              child: _buildInputField('Phone', phone, false,
                                  Icons.phone, currentTheme)),
                          Padding(
                              padding: const EdgeInsets.only(
                                  bottom: 10, left: 10, right: 10),
                              child: _buildInputField('Address', address, false,

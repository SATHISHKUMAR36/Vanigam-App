...
class _SinglecustomerState extends State<Singlecustomer> {
  ...
  addnotes(clientid, date, content, stackholdertype) async {
    await _crmProvider.insertnotes(clientid, _userProvider.selectedworkspace?.branchid,date, content, stackholdertype);
  }
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: Scaffold(
        appBar: AppBar(
          title: Text(
              "${AppLocalizations.of(context).translate("CustomersView")}"),

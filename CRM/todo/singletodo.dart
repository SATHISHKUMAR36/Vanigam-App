...
class SingleTodo extends StatefulWidget {
  ...
  SingleTodo(
      ...
      this.agentid});
  @override
  State<SingleTodo> createState() => _SinglecustomerState();
}

class _SinglecustomerState extends State<SingleTodo> {
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: Scaffold(
        appBar: AppBar(
          title: Text("${AppLocalizations.of(context).translate("TodoView")}"),
